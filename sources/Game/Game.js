    ...
    async init()
    {
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'timeMachineScreenLogo',                 `timeMachine/timeMachineScreenLogo.png`,                                              'texture', (resource) => { resource.flipY = false; resource.minFilter = THREE.NearestFilter; resource.magFilter = THREE.NearestFilter; resource.generateMipmaps = false; resource.wrapS = THREE.ClampToEdgeWrapping; resource.wrapT = THREE.ClampToEdgeWrapping; resource.colorSpace = THREE.SRGBColorSpace; } ],
            ],
            (toLoad, total) =>
            {
